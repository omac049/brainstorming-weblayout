...
|------|--------|-------------|-------|
| **Headings** | `UAGC-Montserrat, sans-serif` | 500, 600, 700 | Actually IS Google Fonts Montserrat (renamed). Served from `fonts.gstatic.com`. Use `next/font/google` with Montserrat. |
