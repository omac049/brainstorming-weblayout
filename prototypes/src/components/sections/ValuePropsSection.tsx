            ...
            {cards.map((card, index) => {
              ...
              return (
                <article
                  key={card.title}
                  className={cn(
                    "reveal-section group relative flex flex-col overflow-hidden rounded-2xl border border-uagc-border bg-white p-4 transition-all duration-200 hover:border-uagc-gold hover:shadow-[0_4px_20px_rgba(12,35,75,0.08)] sm:p-6",
                    `stagger-${index + 1}`,
                ...
                >
                  ...
                  />
                  <span
                    className="mb-3 flex size-9 shrink-0 items-center justify-center rounded-xl bg-uagc-surface text-uagc-navy transition-colors duration-200 group-hover:bg-[#fdf3e0] group-hover:text-uagc-gold sm:mb-4 sm:size-11"
                    aria-hidden
                  >
            ...
            <div className="p-5 sm:p-8 lg:p-10">
              ...
              {experienceCallout.ctaLabel && experienceCallout.ctaHref && (
                <a
                  ...
                  className="mt-4 inline-flex min-h-11 items-center gap-2 rounded-lg bg-uagc-gold px-5 text-sm font-semibold text-uagc-navy transition-colors duration-200 hover:bg-[#d4870a] sm:mt-6"
                >
