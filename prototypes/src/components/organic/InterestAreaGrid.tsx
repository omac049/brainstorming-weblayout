    ...
    >
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
        <div className="mb-8 text-center sm:mb-10">
          ...
          <h2 className="type-h2 text-uagc-navy">What Interests You?</h2>
          <p className="mx-auto mt-3 max-w-2xl text-[0.9375rem] leading-relaxed text-uagc-gray sm:text-base">
            Browse by area of study, then explore programs that match your goals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {AREAS.map((area, index) => (
            <a
              ...
              href={area.href}
              className={cn(
                "group block cursor-pointer overflow-hidden rounded-2xl border border-uagc-border bg-white no-underline transition-all duration-200",
            ...
            >
              ...
              <div className="px-[18px] pb-[18px] pt-4">
                <p className="type-h5 text-uagc-navy">
                  {area.name}
                </p>
                <div className="mt-1.5 flex items-center justify-between gap-3">
                  ...
                  <span className="inline-flex shrink-0 items-center gap-1 text-[13px] font-semibold text-uagc-red transition-all duration-200 group-hover:gap-1.5">
                    Learn More
          ...
          <a
            href={finderHref}
            className={cn(
              "group relative col-span-1 flex cursor-pointer overflow-hidden rounded-2xl border border-white/15 bg-uagc-navy no-underline transition-all duration-200 sm:col-span-2 lg:col-span-1 lg:col-start-4 lg:row-start-2",
          ...
          >
            <div className="relative z-[1] flex min-h-[230px] w-full flex-col justify-between p-6 sm:p-7">
              <div>
                ...
                <p className="type-eyebrow text-white/80">Program Discovery</p>
                <p className="mt-2 type-h5 text-white">
                  Not sure where
                  <br />
                  to start?
                </p>
              </div>
              <span className="inline-flex w-fit items-center gap-2 rounded-lg bg-uagc-gold px-[18px] py-2.5 text-[13px] font-semibold text-uagc-navy transition-colors duration-200 group-hover:bg-[#d4870a]">
                Find Your Degree
                <ArrowRight className="size-3" strokeWidth={2.5} aria-hidden />
              </span>
            </div>
