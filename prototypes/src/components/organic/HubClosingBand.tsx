...
interface HubClosingBandProps {
  rfiFormRef: RefObject<HTMLDivElement | null>;
}

export function HubClosingBand({ rfiFormRef }: HubClosingBandProps) {
  ...
  return (
    <section
      ref={ref}
      id="rfi"
      className="scroll-mt-24 bg-uagc-navy py-12 sm:py-16 lg:scroll-mt-36"
    ...
    >
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
        <div
          id="next-steps"
          className={cn(
            "mx-auto max-w-3xl scroll-mt-20 text-center reveal-section",
            isVisible && "is-visible",
          )}
        >
          <span aria-hidden className="mx-auto mb-3 accent-bar" />
          <h2 id="hub-closing-heading" className="type-h2 text-white">
            Ready to Start Your{" "}
            <span className="text-uagc-gold">Degree?</span>
          </h2>
          <p className="mt-3 text-sm leading-relaxed text-uagc-navy-muted sm:text-base">
            Connect with an advisor, call, apply, or request information below.
          </p>
        </div>
        ...
        <div
          id="hub-rfi-form"
          className="mx-auto mt-12 w-full max-w-[880px] scroll-mt-24 border-t border-white/10 pt-10 sm:mt-14 sm:pt-12"
        >
          <h3 className="text-center type-h3 text-white">
            Or Request Information{" "}
            <span className="text-uagc-gold">Here</span>
          </h3>
          <p className="mx-auto mt-3 max-w-lg text-center text-sm leading-relaxed text-uagc-navy-muted sm:text-base">
            Get paired with an enrollment advisor who can help you find the right
            program, transfer credits, and understand your cost.
          </p>
          <div className="mt-8">
            <RFIForm variant="full" heroFormRef={rfiFormRef} />
          </div>
          <p className="mt-3 text-center text-sm text-uagc-navy-muted">
