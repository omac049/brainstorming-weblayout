...
function PathCard({ icon: Icon, title, description, href, linkLabel, index }: PathCardProps & { index: number }) {
  return (
    <motion.div custom={index} variants={cardVariants} initial="hidden" animate="visible">
      ...
      >
        <span className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-uagc-cream-warm transition-[transform,background-color] duration-150 group-hover:bg-uagc-navy/10 group-hover:scale-105">
          <Icon className="size-5 text-uagc-navy" strokeWidth={1.75} aria-hidden />
        </span>
        ...
        <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-uagc-navy transition-colors duration-150 group-hover:text-uagc-sky">
          {linkLabel}
                ...
                return (
                  ...
                  >
                    ...
                    <span className="relative flex items-center gap-2">
                      <Icon
                        className={`size-4 sm:size-[1.125rem] transition-colors duration-150 ${isActive ? "text-uagc-sky" : "text-uagc-gray"}`}
                        strokeWidth={1.75}
                        aria-hidden
                      />
      ...
      <div ref={ctaRevealRef} className="bg-uagc-navy py-12 sm:py-16" id="next-steps">
        <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <a
              href="?chat=default"
              className="group flex min-h-11 cursor-pointer flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/6 px-5 py-6 transition-[transform,border-color,background-color] duration-200 hover:border-uagc-navy/40 hover:bg-white/10 active:scale-97 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uagc-sky sm:py-8"
            >
              <span className="flex size-12 items-center justify-center rounded-full bg-uagc-sky/10 text-uagc-navy transition-[transform,background-color] duration-150 group-hover:bg-uagc-sky/20 group-hover:scale-105">
            ...
            <a
              href="#rfi"
              className="group flex min-h-11 cursor-pointer flex-col items-center gap-3 rounded-2xl border border-uagc-navy/40 bg-uagc-sky/10 px-5 py-6 transition-[transform,border-color,background-color] duration-200 hover:border-uagc-navy/40 hover:bg-uagc-sky/15 active:scale-97 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uagc-sky sm:py-8"
            >
              <span className="flex size-12 items-center justify-center rounded-full bg-uagc-sky/15 text-uagc-navy transition-[transform,background-color] duration-150 group-hover:bg-uagc-sky/20 group-hover:scale-105">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <a
              ...
              className="group flex min-h-11 cursor-pointer flex-col items-center gap-3 rounded-2xl border border-uagc-sky/30 bg-uagc-sky/10 px-5 py-6 transition-[transform,border-color,background-color] duration-200 hover:border-uagc-sky/50 hover:bg-uagc-sky/15 active:scale-97 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uagc-sky sm:py-8"
            >
              <span className="flex size-12 items-center justify-center rounded-full bg-uagc-sky/20 text-uagc-navy transition-[transform,background-color] duration-150 group-hover:bg-uagc-sky/30 group-hover:scale-105">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
