...
function PathCard({ icon: Icon, title, description, href, linkLabel, index }: PathCardProps & { index: number }) {
  return (
    <motion.div custom={index} variants={cardVariants} initial="hidden" animate="visible">
      <Link
        href={href}
        className="group relative flex h-full cursor-pointer flex-col rounded-2xl border border-[#e8e6e3] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all duration-200 hover:border-[#d4cfc9] hover:shadow-[0_4px_12px_rgba(12,35,75,0.08)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uagc-navy sm:p-7"
      >
        <span className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-[#fdf8ef] transition-all duration-150 group-hover:bg-[#fcefd4] group-hover:scale-105">
...
export function HomeDifferentiatorPathSection({ show = "all" }: HomeDifferentiatorPathSectionProps) {
  ...
  return (
    ...
    >
      ...
      {(show === "all" || show === "tabs") && <div className="section-pad bg-white">
        <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex justify-center">
            <div
              ref={tablistRef}
              className="relative inline-flex w-full max-w-lg gap-1 rounded-full border border-[#e8e6e3] bg-[#f7f6f5] p-1.5 shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)] sm:w-auto"
              role="tablist"
      ...
      {(show === "all" || show === "cta") &&
      <div className="bg-uagc-navy py-12 sm:py-16" id="next-steps">
        <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <a
              href="?chat=default"
              className="group flex min-h-[44px] cursor-pointer flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.06] px-5 py-6 transition-all duration-200 hover:border-uagc-gold/40 hover:bg-white/[0.1] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uagc-gold sm:py-8"
            >
              <span className="flex size-12 items-center justify-center rounded-full bg-uagc-gold/15 text-uagc-gold transition-all duration-150 group-hover:bg-uagc-gold/25 group-hover:scale-105">
              ...
              <span className="text-xs leading-relaxed text-[#8a9bb5]">Get instant answers online</span>
            </a>
            ...
            >
              ...
              <span className="text-xs leading-relaxed text-[#8a9bb5]">+1 866 711 1700</span>
            </a>

            <a
              href="#rfi"
              className="group flex min-h-[44px] cursor-pointer flex-col items-center gap-3 rounded-2xl border border-uagc-gold/30 bg-uagc-gold/[0.08] px-5 py-6 transition-all duration-200 hover:border-uagc-gold/50 hover:bg-uagc-gold/[0.14] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uagc-gold sm:py-8"
            >
              <span className="flex size-12 items-center justify-center rounded-full bg-uagc-gold/20 text-uagc-gold transition-all duration-150 group-hover:bg-uagc-gold/30 group-hover:scale-105">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              ...
              <span className="text-xs leading-relaxed text-[#8a9bb5]">We&apos;ll reach out to you</span>
            </a>
            ...
            <a
              ...
              className="group flex min-h-[44px] cursor-pointer flex-col items-center gap-3 rounded-2xl border border-uagc-red/30 bg-uagc-red/[0.08] px-5 py-6 transition-all duration-200 hover:border-uagc-red/50 hover:bg-uagc-red/[0.14] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uagc-red sm:py-8"
            >
              <span className="flex size-12 items-center justify-center rounded-full bg-uagc-red/15 text-uagc-red transition-all duration-150 group-hover:bg-uagc-red/25 group-hover:scale-105">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              ...
              <span className="text-xs leading-relaxed text-[#8a9bb5]">$0 application fee</span>
            </a>
          </div>

          <div className="mt-8 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-[#8a9bb5]">
